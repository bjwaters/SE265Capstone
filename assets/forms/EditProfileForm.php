...
<div id = "editProfile" class="container border my-4 col-5">
    <div class="flex-grow ">
        <form name = "editForm" method = 'post' action = "indexLog.php" enctype = "multipart/form-data">
            ...
            <div class="flex-row border ml-3"><h3>Public Profile (Editing)</h3></div>
            ...
            <div class="d-flex flex-row border">
                ...
                <div class="col border">
                    ...
                    Name: <input type="text" name="userName" value="<?php echo $editUserName;?>"/> <br>
    ...
    <div class="d-flex flex-row border">
        <div class="col border" style="width:200px;">
            Picture: <input type = 'file' name = 'file' id="file">
        </div>
        <div class="col border mr-auto">
