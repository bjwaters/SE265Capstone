...
function newMessage($db, $booker_id, $musician_id, $sender_id, $text){  //Function to add a new user to the users table
    try{
        $sql = $db->prepare("INSERT INTO messages VALUES (null, :booker_id, :musician_id, :sender_id, :text, now())"); //sql statement to add placeholders to database
